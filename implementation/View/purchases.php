...
if(isset($_GET["filter"])){
    ...
    if(!empty($_GET["category"])){
        ...
        $purchases = Purchase::FilterPurchases($category, $product, $start_date, $end_date);
    }else{
    ...
    <section class="container-fluid center">
        <div class="row d-flex justify-content-around">
            ...
            <div class="col-md-10 py-3">
                <h3 class="text-center text-info">Purchases Section</h3>
                <div class="row">
                    <div class="col-md-9">
                        <div class="row py-3">
                                ...
                                <?php if($purchases->num_rows > 0){
                                    ...
                                    foreach($purchases as $p){
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $p["number_received"];  ?></td>
                                            <td><?php echo $p["purchase_date"];  ?></td>
                                            <td><a href="edit-purchases.php?edit_pur=<?php echo $p["purchase_id"]; ?>" class="btn btn-info btn-sm"><i class="fas fa-pencil-alt"></i></a></td>
                                            <td><a href="../Controller/PurchaseController.php?delete_pur=<?php echo $p["purchase_id"]; ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></a></td>
                                        </tr>

                                        <?php $i++; }  }else{ ?>
                                    <tr class="text-center text-danger"><td colspan="9">No Purchases Yet</td></tr>
                    ...
                    <div class="col-md-3">
                        <h5 class="text-info text-center mb-3">Add New Purchase</h5>
                        <form class="p-3 border rounded border-success" action="../Controller/PurchaseController.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="number_received" type="number" placeholder="Quantity Purchased">
                            </div>
                            ...
                            <div class="form-group">
                                <input type="submit" name="add_purchase" value="Add Purchase" class="btn btn-success d-flex ml-auto">
                            </div>
                        </form>
                    </div>
                </div>
